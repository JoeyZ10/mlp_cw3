...
from PyT_learning.mlp import data_providers
from local_attention import LocalAttention

from reformer_pytorch.reformer_pytorch import default, LSHAttention, FullQKAttention, merge_dims, split_at_index, \
